...
\begin{frame}
	\frametitle{Transmission Packets}
...
\begin{frame} % when one board crashes
  ...
  \includegraphics<1>[width=0.4\textwidth]{img/mesh-routing1.png} 
  \includegraphics<1>[width=0.4\textwidth]{img/mesh-routing2.png} \\

  \begin{tabular}{ll}
    \includegraphics[height=0.2in]{img/pink.png} & Zigbee Network Coordinator\\
    \includegraphics[height=0.2in]{img/green} & Zigbee Network Router
  \end{tabular}
