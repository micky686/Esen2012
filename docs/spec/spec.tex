...
\noindent
\begin{tabular}{+p{1.3in}+p{2.7in}+p{1.3in}+p{1in}}

Syntax  & Operands   & Program counter & Flags\\

\texttt{add reg_d, reg_r} & \texttt{reg_0 $\leq$ reg_d $\leq$ reg_6, acc, reg_0 $\leq$ reg_r $\leq$ reg_6, acc} & \texttt{PC = PC + 1} & \texttt{C} \\
...
\noindent
\begin{tabular}{+p{1.3in}+p{2.6in}+p{1.3in}+p{1in}}

Syntax  & Operands   & Program counter & Flags\\

\texttt{add reg_r, value} & \texttt{reg_0 $\leq$ reg_r $\leq$ reg_6, acc, 0x00 $\leq$ value $\leq$ 0xFF} & \texttt{PC = PC + 1} & \texttt{C} \\
...
\texttt{sub reg_m, reg_s} & \texttt{reg_0 $\leq$ reg_m $\leq$ reg_6, acc, reg_0 $\leq$ reg_s $\leq$ reg_6, acc} & \texttt{PC = PC + 1} & \texttt{C} \\
...
\texttt{sub reg_m, value} & \texttt{reg_0 $\leq$ reg_m $\leq$ reg_6, acc, 0x00 $\leq$ value $\leq$ 0xFF} & \texttt{PC = PC + 1} & \texttt{C} \\
...
\texttt{div reg_d, reg_r} & \texttt{reg_0 $\leq$ reg_d $\leq$ reg_6, acc, reg_0 $\leq$ reg_r $\leq$ reg_6, acc} & \texttt{PC = PC + 1} & \texttt{C} \\
...
\texttt{div reg_d, value} & \texttt{reg_0 $\leq$ reg_d $\leq$ reg_6, acc, 0x00 $\leq$ value $\leq$ 0xFF} & \texttt{PC = PC + 1} & \texttt{C} \\
...
\texttt{mul reg_d, reg_r} & \texttt{reg_0 $\leq$ reg_d $\leq$ reg_6, acc, reg_0 $\leq$ reg_r $\leq$ reg_6, acc} & \texttt{PC = PC + 1} & \texttt{C} \\
...
\texttt{mul reg_d, value} & \texttt{reg_0 $\leq$ reg_d $\leq$ reg_6, acc, 0x00 $\leq$ value $\leq$ 0xFF} & \texttt{PC = PC + 1} & \texttt{C} \\
...
\noindent
\begin{tabular}{+p{1.8in}+p{2.7in}+p{1.3in}}

Syntax  & Operands   & Program counter \\

\texttt{compare reg_d, reg_r} & \texttt{reg_0 $\leq$ reg_d $\leq$ reg_6, acc, reg_0 $\leq$ reg_r $\leq$ reg_6, acc} & \texttt{PC = PC + 1} \\
...
\noindent
\begin{tabular}{+p{1.9in}+p{2.6in}+p{1.3in}}

Syntax  & Operands   & Program counter \\

\texttt{compare reg_d, value} & \texttt{reg_0 $\leq$ reg_d $\leq$ reg_6, acc, 0x00 $\leq$ value $\leq$ 0xFF} & \texttt{PC = PC + 1} \\
...
\texttt{sendmsg reg, agent, platform} & \texttt{platform_0 $\leq$ platform $\leq$ platform_3} & \texttt{PC = PC + 1}\\
 ...
 & \texttt{reg_0 $\leq$ reg $\leq$ reg_6, acc} & \\
...
\texttt{pullmsg} & \texttt{reg_0 $\leq$ reg $\leq$ reg_6, acc} & \texttt{PC = PC + 1} \\
 & \texttt{reg_str_0 $\leq$ reg $\leq$ reg_str_2} & \\
...
\noindent
\begin{tabular}{+p{1.8in}+p{2.6in}+p{1.3in}}

Syntax  		  & Operands   								     & Program counter       \\

\texttt{store reg_d, value} & \texttt{reg_0 $\leq$ reg_d $\leq$ reg_6, acc, 0x00 $\leq$ value $\leq$ 0xFF} & \texttt{PC = PC + 1}  \\
...
\texttt{mv reg_d, reg_r} & \texttt{reg_0 $\leq$ reg_d $\leq$ reg_6, acc  reg_0 $\leq$ reg_r $\leq$ reg_6, acc} & \texttt{PC = PC + 1}  \\
...
\texttt{setservice service_id, reg} & \texttt{service_0 $\leq$ service_id $\leq$ service_255, reg_0 $\leq$ reg $\leq$ reg_6, acc} & \texttt{PC = PC + 1}  \\
