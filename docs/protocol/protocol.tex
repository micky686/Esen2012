...
\lstinputlisting{src/platform.h}
\subsection{platform.c}
\lstinputlisting{src/platform.c}
\subsection{scheduler.h}
\lstinputlisting{src/scheduler.h}
\subsection{scheduler.c}
\lstinputlisting{src/scheduler.c}
\subsection{hw\_layer.h}
\lstinputlisting{src/hwlayer.h}
\subsection{exe\_layer.h}
\lstinputlisting{src/exelayer.h}
\subsection{exe\_layer.c}
\lstinputlisting{src/exelayer.c}
\subsection{comm\_layer.h}
\lstinputlisting{src/commlayer.h}
\subsection{comm\_layer.c}
\lstinputlisting{src/commlayer.c}

\section{Agent assembler tool}
\subsection{asm\_agent}
\lstset{ language=Python, }
\lstinputlisting{src/asmagent}

\section{Communication protocol}
\lstset{ language=C, }
\subsection{protocol0.h}
\lstinputlisting{src/protocol0.h}
\subsection{protocol0.c}
\lstinputlisting{src/protocol0.c}
<<<<<<< HEAD
=======
...
>>>>>>> d99a4ada9fba07bf7b2e38d016e6bf27062cbde9
