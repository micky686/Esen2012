...
The use cases used to validate the final deliverable are shown in Table~\ref{tab:validacases}. 
...
\caption{Use Cases for System Validation }
\end{table}
...
\lstinputlisting{../../src/library/platform/include/platform.h}
\subsection{platform.c}
\lstinputlisting{../../src/library/platform/src/platform.c}
\subsection{scheduler.h}
\lstinputlisting{../../src/library/platform/include/scheduler.h}
\subsection{scheduler.c}
\lstinputlisting{../../src/library/platform/src/scheduler.c}
\subsection{hw\_layer.c}
\lstinputlisting{../../src/library/platform/src/scheduler.c}
\subsection{hw\_layer.c}
%\lstinputlisting{../../src/library/platform/src/hw_layer.c}
...
%\lstinputlisting{../../src/app/asm/asm\_agent}
\lstset{
	language=Python,
	}
\section{Platform}
