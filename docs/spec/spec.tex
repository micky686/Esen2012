...
\textbf{Syntax}  & \textbf{Operands}   & \textbf{Program counter} & \textbf{Flags}\\
...
\hline
\texttt{0101} & \texttt{rrrr} & \texttt{vvvv} & \texttt{vvvv}\\
...
\noindent
Subtract reg_s (or value) from reg_m and put the result into acc.\\
\noindent
\texttt{sub reg_m, reg_s}
